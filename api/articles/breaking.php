<?php
/**
 * API - Get Breaking News Articles
 * Replaces the "Popular News" section - Admin controlled via is_breaking flag
 */
...
try {
    ...
    $articles = $db->fetchAll("
        ...
        WHERE a.status = 'published' AND a.is_breaking = 1 AND a.show_in_app = 1
    ...
    error_log("Breaking news error: " . $e->getMessage());
