...
try {
    $articles = $db->fetchAll("
        SELECT 
            ...
            a.views_count, a.likes_count, a.is_live, a.is_breaking, a.published_at as created_at,
        ...
        WHERE a.status = 'published' AND a.show_in_app = 1
    ...
    $formattedArticles = array_map(function($article) use ($db) {
        ...
        return [
            ...
            'image_url' => $article['thumbnail'] ? BASE_URL . '/' . $article['thumbnail'] : null,
